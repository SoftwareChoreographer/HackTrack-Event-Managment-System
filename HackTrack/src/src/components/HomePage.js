            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  <li>
                    <Link className="dropdown-item" to="/secondnotification">
                      Notifications
                    </Link>
                  </li>
                  <li>
      ...
      <div className="container my-5 position-relative">
        ...
        >
          ...
          <div className="card" style={{ minWidth: "300px" }}>
            <img
              src="https://via.placeholder.com/400x200?text=Event+1"
          ...
          <div className="card" style={{ minWidth: "300px" }}>
            <img
              src="https://via.placeholder.com/400x200?text=Event+2"
              className="card-img-top"
              alt="Event 2"
            />
            <div className="card-body text-center">
          ...
          <div className="card" style={{ minWidth: "300px" }}>
            <img
              src="https://via.placeholder.com/400x200?text=Event+3"
              className="card-img-top"
              alt="Event 3"
            />
            <div className="card-body text-center">
          ...
          <div className="card" style={{ minWidth: "300px" }}>
            <img
              src="https://via.placeholder.com/400x200?text=Event+4"
              className="card-img-top"
              alt="Event 4"
            />
            <div className="card-body text-center">
