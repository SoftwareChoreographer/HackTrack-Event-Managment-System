...
const CreateEvent = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const formattedDateTime = formData.date_time.replace("T", " ") + ":00";

    const submitData = new FormData();
    submitData.append("name", formData.name);
    submitData.append("description", formData.description);
    submitData.append("location", formData.location);
    submitData.append("date_time", formattedDateTime);
    if (formData.image_data) {
      submitData.append("image_data", formData.image_data);
    }
  ...
  return (
    <div>
      {/* Back Button */}
      <button
        className="btn btn-dark mb-3 ms-3 mt-3 text-white"
        ...
        >
          ...
          <div className="mb-3">
            ...
            <input
              type="datetime-local"
              className="form-control"
              id="date_time" // Matches date_time column
          ...
          <div className="mb-3">
            ...
            <input
              type="file"
              className="form-control"
              id="image_data" // Matches image_data column
              accept="image/*"
